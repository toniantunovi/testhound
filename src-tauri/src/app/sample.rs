...
pub fn seed(paths: &Paths) -> Result<()> {
    ...
    let cases: &[CaseSpec] = &[
        CaseSpec {
            ...
            kinds: &[CaseType::Functional, CaseType::Regression],
            owner: "priya",
        ...
        CaseSpec {
            ...
            section: Some("cart"),
            priority: Priority::Medium,
            kinds: &[CaseType::E2e, CaseType::Regression],
            owner: "lena",
            tags: &["cart"],
        ...
        CaseSpec {
            ...
            section: None,
            priority: Priority::Critical,
            kinds: &[CaseType::Smoke, CaseType::Regression],
            owner: "marco",
            tags: &["auth", "p1", "smoke"],
            automation: AutomationState::Linked,
            steps: &[
